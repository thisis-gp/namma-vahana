"""Train final model on all train data; write submission CSVs.
Set BEST_ITER and W_LOOKUP from validate.py output before the final run.
"""
import numpy as np
import pandas as pd
...
def main():
    ...
    pred_blend = np.clip(W_LOOKUP * pred_lookup + (1 - W_LOOKUP) * pred_gbm, 0.0, 1.0)
